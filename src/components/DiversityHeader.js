...
export default function Header() {
  ...
  return (
    <nav className="bg-white border-gray-200 dark:bg-transparent fixed w-full top-0 z-10">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div
          ...
          id="navbar-language"
        >
          <div className="flex items-center md:order-2 bg-[#01264A] lg:bg-transparent">
            {/* Dropdown */}

            <ul className="flex flex-col font-medium items-center p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-[#01264A] md:dark:bg-transparent dark:border-transparent">
              <li>
                <button
                  type="button"
                  class="py-2.5 px-5 mr-2 mb-2 flex text-sm font-medium text-white lg:text-black focus:outline-none bg-white rounded-sm border border-white  focus:z-10  dark:bg-transparent dark:text-white dark:border-transparent "
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="28"
                  ...
                  >
                    <path
                      d="M5.99999 5.9757C5.51542 5.9757 5.03085 5.78879 4.66396 5.4219L0.150563 0.908509C-0.0501876 0.707759 -0.0501876 0.375483 0.150563 0.174733C0.351313 -0.0260177 0.683589 -0.0260177 0.88434 0.174733L5.39774 4.68813C5.73002 5.0204 6.26996 5.0204 6.60224 4.68813L11.1157 0.174733C11.3164 -0.0260177 11.6487 -0.0260177 11.8494 0.174733C12.0502 0.375483 12.0502 0.707759 11.8494 0.908509L7.33602 5.4219C6.96913 5.78879 6.48456 5.9757 5.99999 5.9757Z"
                      fill="white"
                    />
                  </svg>
                </button>
              ...
              <li>
                <button
                  type="button"
                  class="py-2.5 px-7 mr-2 mb-2 text-sm font-medium rounded-sm text-white lg:text-gray-900 border-2 border-white lg:border-gray-900  dark:bg-transparent"
                >
                  LIVE CHAT
                </button>
              </li>
